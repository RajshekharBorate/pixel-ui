...
> implementation. After Reviewer/quality, run **Bugfix** until human green (`G7`).
...
| 1b | `AI-ORCHESTRATION.md` (when multi-agent) | How to run Discovery → Architect → Implementer → Reviewer → Bugfix |
