...
3. `AI-ORCHESTRATION.md` when running the multi-agent PAGE/LIBRARY pipeline (`tools/agent-prompts/`).
4. `projects/pixel-ui/CONVENTIONS.md` for mechanical Angular, theming, overlay, and testing rules.
5. `projects/pixel-ui/src/public-api.ts` for the supported import surface.
6. Component or service `README.md` files under `projects/pixel-ui/src/lib/` for behavior contracts.
7. `projects/docs/src/app/registry/components/*.meta.ts` for curated summaries and docs taxonomy.
8. `projects/docs/src/app/examples/**` for runnable examples.
9. `projects/pixel-ui/AI-MANIFEST.json` for the generated machine-readable union of the sources above.
